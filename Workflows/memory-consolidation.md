...
- [ ] Contradicts a `Knowledge/People/` or `Knowledge/Reference/` file → **update My-OS to match**
- [ ] Contains AI PM mission signal (RegEval, Bruce Wayne, frontier-lab contacts) → **promote to My-OS Knowledge**
- [ ] Is stale (project completed, decision superseded) → **archive or delete**
- [ ] Duplicates a My-OS file → **delete from Cowork, keep My-OS**

### Step 2 — Scan My-OS Knowledge (10 min)
...
When Cowork memory contradicts My-OS:

1. Check which is more recent
2. Check which has primary source evidence (meeting file, decision doc)
3. **My-OS wins** unless Cowork has more recent primary source evidence
