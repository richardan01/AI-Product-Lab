...
| onboarding | Workflows/interactive-onboarding.md (HEAD_OF_DEPT, Phase 7 content-exclusion, Phase 6 explicit-yes, Phase 8 deferred/privacy) + grade.sh + eval-03 criteria | 2026-06-22 | pending (ran 2026-06-23 — content PASS, temporal NOT-RUN) | onboarding/results/2026-06-23_claude-opus-4-8.md — content evals 0 ❌ (7✅/2⚠); NOT fully citable until temporal 02/07 run on a real eval-runner |
