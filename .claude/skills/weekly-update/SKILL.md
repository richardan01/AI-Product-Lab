---
description: Draft weekly update for manager — gathers task progress, metrics, and status assessment
disable-model-invocation: true
---

# Weekly Update

**Agent:** Stakeholder Manager (Commissioner Gordon voice) — see `Agents/agent-system-architecture.md` voice map.
